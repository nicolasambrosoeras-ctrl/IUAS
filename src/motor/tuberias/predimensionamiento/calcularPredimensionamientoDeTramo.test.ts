...
describe('calcularPredimensionamientoDeTramo', () => {
  ...
  it('di_min_mm coincide con calcularDiametroInteriorMinimo(ae_cm2)', () => {
    const qc_lps = 0.9
    const resultado = calcularPredimensionamientoDeTramo(qc_lps)

    expect(resultado.di_min_mm).toBe(calcularDiametroInteriorMinimo(resultado.ae_cm2))
  })
  ...
  it('caso representativo del proyecto (t-general M2): Qc=0.7273238618387272 l/s', () => {
    ...
    expect(resultado.di_min_mm).toBeCloseTo(21.518102875515787, 9)
  })
